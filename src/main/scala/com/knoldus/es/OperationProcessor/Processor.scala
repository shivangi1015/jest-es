...
object Processor extends ElasticSearchOperations with App {
  ...
  */
  ...
  /*  println("---Getting data from ElasticSearch---")
    val searchRes = search("company", "employee")
    println("match all query result: " + searchRes)*/

  println("----- Updating data in ElasticSearch ---------")
  ...
  //  println("Deleting from Elastic search: " + delete("company"))
